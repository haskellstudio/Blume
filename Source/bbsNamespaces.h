...
#ifndef bbsNamespaces
#define bbsNamespaces

//When this file is included, the core namespaces will be brought into scope.

//First include the core Belle, Bonne, Sage library.
#include "bbs.h"

//Now bring the core namespaces into scope.
using namespace prim;
using namespace prim::math;
using namespace prim::colors;
using namespace prim::unicode;
using namespace bbs;
