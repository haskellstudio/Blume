...
namespace prim
{
  ...
  public:
    ...
    ///Checks to see whether a string contains another string.
    bool Contains(const prim::ascii* FindString, count StartIndex = 0)
    {
      count DummyVariable = 0;
      return Find(FindString, DummyVariable, StartIndex);
    }
